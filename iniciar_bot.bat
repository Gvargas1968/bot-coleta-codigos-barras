...
if not exist ".env.local" (
    ...
    echo # MYSQL_USER=seu_usuario >> .env.local
    echo # MYSQL_PASSWORD=sua_senha_segura >> .env.local
    echo # MYSQL_DATABASE=nome_do_banco >> .env.local
    echo. >> .env.local
    echo [INFO] Arquivo .env.local criado com exemplos comentados.
    echo [INFO] Voce precisa editar este arquivo com suas configuracoes reais.
